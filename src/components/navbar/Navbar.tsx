  ...
  render(): React.ReactNode {
    return (
      <Header>
        ...
        <Group>
          {(window.location.pathname === '/' || window.location.pathname === '') && <FilterButton onClick={() => this.props.setFilterOpen(!this.props.filterOpen)} filterOpen={this.props.filterOpen} isOpen={this.props.isOpen}>
        ...
        <Group className='navMenu' mr='lg'>
          {(!localStorage.getItem('Authorization') && window.location.pathname !== '/login') ? <Button className="navButton" size='lg' radius='lg' component={Link} to='/login' compact>Login or Sign Up</Button> : (!localStorage.getItem('Authorization') && window.location.pathname !== '/login') ? <Button className="navButton" size='lg' radius='lg' component={Link} to='/login' compact>Login or Sign Up</Button> : ''}
